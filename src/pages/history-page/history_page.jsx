            ...
            <Container maxWidth="lg" className="main-content">
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={9}>
                        <Typography variant="h5" style={{ color: '#fff' }}>Truyện đã đọc gần đây</Typography>
                                            ...
                                            <TableCell>
                                                <Box display="flex" flexWrap="wrap">
                                                    {novel.status.map((status, idx) => (
                                                        <Badge key={idx} badgeContent={status} color={status === 'Full' ? 'success' : status === 'Mới' ? 'primary' : 'error'} />
                                                    ))}
                                                </Box>
                                            </TableCell>
                    ...
                    <Grid item xs={12} sm={3} className="right-section">
